<?php 
	...
	if(isset($_POST['info'])){
		...
		if(filesize("messages1.json") == 0){
			...
			$old_records = json_decode(file_get_contents("messages1.json"));
		...
		if(!file_put_contents("messages1.json", json_encode($data_to_save, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE), LOCK_EX)){
